...
public class TeenController {
    ...
    public final TeenService teenService;
    ...
    public Flux<TeenResponseDto> getDataForIdTutor(@PathVariable Integer idTutor) {
        return this.teenService.findAllIdtutor(idTutor);
    }
